...
use routes::{
    ...
    api_get_server_config, api_get_session, api_get_team_template, api_get_workspace,
    api_get_workspace_skills, api_graph, api_headings, api_health, api_import_team_template,
    api_index_rebuild, api_index_status, api_indexing_state, api_inspect_draft, api_inspector,
    api_language_graph, api_link_targets, api_links, api_list_files, api_list_sessions,
    api_list_team_templates, api_list_windows, api_metadata_export, api_metadata_import, api_move,
    ...
    api_restart_terminal, api_save_team_template, api_screensaver_clear_pin, api_screensaver_patch,
